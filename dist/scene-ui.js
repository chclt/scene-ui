...
`;class J extends g{constructor(){super(),this.href="#",this.active=!1}render(){return f`
        ...
        `}}u(J,"styles",[v(N),v(Lt)]),u(J,"properties",{href:{type:String},active:{type:Boolean,reflect:!0}});customElements.define("scene-window-aside-item",J);const Mt=`:host{display:inline;cursor:pointer;text-decoration-line:underline}
`;class Y extends g{constructor(){super()}render(){return f`
            <slot></slot>
        `}}u(Y,"styles",[v(N),v(Mt)]),u(Y,"properties",{href:{type:String}});customElements.define("scene-window-link",Y);const Rt=`:host{display:flex;flex:1 1 0%;flex-direction:column;overflow:hidden;overflow-y:hidden}::slotted(*){flex-shrink:0}
`;class G extends g{constructor(){super(),this.requestUpdate()}get pageList(){return Array.from(this.childNodes).filter(t=>t.tagName==="SLOT").map(t=>(t=t.assignedElements()[0],{title:t.title,path:t.slot}))}render(){return f`
            ...
            -->
        `}back(){this.dispatchEvent(new CustomEvent("scenewindowback",{bubbles:!0,composed:!0}))}}u(G,"styles",[v(N),v(Rt)]),u(G,"properties",{path:{type:String,reflect:!0}});customElements.define("scene-window-main",G);const jt=`:host{width:100%;overflow:auto;white-space:normal;padding-top:2.5rem}
`;class Q extends g{constructor(){super(),this.title="Page Title"}render(){return f`
            <slot></slot>
        `}}u(Q,"styles",[v(N),v(jt)]),u(Q,"properties",{title:{type:String}});customElements.define("scene-window-page",Q);

...
`;class J extends v{constructor(){super()}render(){return g`
            <slot></slot>
        `}}u(J,"styles",[f(N),f(Lt)]),u(J,"properties",{href:{type:String}});customElements.define("scene-window-link",J);const Mt=`:host{display:flex;flex:1 1 0%;flex-direction:column;overflow:hidden;overflow-y:hidden}::slotted(*){flex-shrink:0}
